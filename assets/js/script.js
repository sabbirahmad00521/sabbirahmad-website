    ...
    var skillSlider = new Swiper('.skills-slider .swiper', {
        ...
        on: {
            init: function() {
                ...
                var visibleSlides = this.slides.length - this.params.slidesPerView + 1;
    
                // Update the counter or any other element with this value
            ...
            slideChange: function() {
                // Recalculate on slide change, especially if dynamic changes occur
                var visibleSlides = this.slides.length - this.params.slidesPerView + 1;
                $('.skills-slider-navigation .counter').html(
                    '<span class="text-theme">' +
                    (this.realIndex + 1) +
